...
class gsp_commerceTrial_extrascreate_gsp extends GroovyPage {
...
invokeTag('eachError','g',25,['bean':(extrasInstance),'var':("error")],3)
printHtmlPart(18)
})
invokeTag('hasErrors','g',27,['bean':(extrasInstance)],2)
printHtmlPart(11)
createTagBody(2, {->
printHtmlPart(19)
...
invokeTag('form','g',35,['url':([resource:extrasInstance, action:'save'])],2)
printHtmlPart(22)
})
...
public static final long LAST_MODIFIED = 1399525686000L
