...
class gsp_commerceTrial_addresscreate_gsp extends GroovyPage {
...
createTagBody(1, {->
printHtmlPart(1)
invokeTag('captureMeta','sitemesh',4,['gsp_sm_xmlClosingForEmptyTag':(""),'name':("layout"),'content':("retail_main")],-1)
printHtmlPart(1)
...
public static final long LAST_MODIFIED = 1399525495000L
