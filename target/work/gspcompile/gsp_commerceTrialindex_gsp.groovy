...
class gsp_commerceTrialindex_gsp extends GroovyPage {
...
printHtmlPart(7)
createTagBody(3, {->
expressionOut.print(c.logicalPropertyName)
})
invokeTag('link','g',95,['controller':(c.logicalPropertyName)],3)
printHtmlPart(8)
}
printHtmlPart(9)
})
...
public static final long LAST_MODIFIED = 1399524209000L
