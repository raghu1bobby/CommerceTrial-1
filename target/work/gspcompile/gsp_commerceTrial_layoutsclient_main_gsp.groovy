...
class gsp_commerceTrial_layoutsclient_main_gsp extends GroovyPage {
public String getGroovyPageFileName() { "/WEB-INF/grails-app/views/layouts/client_main.gsp" }
public Object run() {
Writer out = getOut()
...
printHtmlPart(3)
invokeTag('render','g',44,['template':("templates/menuHeader"),'contextPath':("/")],-1)
printHtmlPart(3)
invokeTag('layoutBody','g',45,[:],-1)
printHtmlPart(12)
invokeTag('render','g',48,['template':("templates/footer"),'contextPath':("/")],-1)
printHtmlPart(3)
})
...
public static final long LAST_MODIFIED = 1399532517000L
